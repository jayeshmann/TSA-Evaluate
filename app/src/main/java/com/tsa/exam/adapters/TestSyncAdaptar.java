...
/**
 * Created by Akhil Tripathi on 04-09-2017.
 */

public class TestSyncAdaptar extends BaseAdapter {

    public TestSyncAdaptar(ArrayList<ResultModel> resultModelArrayList, Context context) {
    ...
    public Object getItem(int position) {
        return resultModelArrayList.get(position);
    }
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        holder.canID.setText(resultModelArrayList.get(position).getCandidateLoginID());
       ...
       holder.sync.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String candidateID=resultModelArrayList.get(position).getCandidateLoginID();
    ...
    public void submitResult(final String candidateID, final String questionID, final String timeVisited, final String loginTime, final String logoutTime,final String status) {
        ...
        try {
            ...
            Toast.makeText(context, " Synced Success both Exam And Video",Toast.LENGTH_LONG).show();
